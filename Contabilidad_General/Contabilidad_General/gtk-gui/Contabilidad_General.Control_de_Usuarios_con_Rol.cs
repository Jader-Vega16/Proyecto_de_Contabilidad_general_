...
namespace Contabilidad_General
{
	public partial class Control_de_Usuarios_con_Rol
	{
		...
		protected virtual void Build()
		{
			...
			this.txtIDUsuarioRol.IsEditable = false;
			...
			this.vbox36.Add(this.txtFecha);
			global::Gtk.Box.BoxChild w23 = ((global::Gtk.Box.BoxChild)(this.vbox36[this.txtFecha]));
			w23.Position = 1;
			w23.Expand = false;
			w23.Fill = false;
			// Container child vbox36.Gtk.Box+BoxChild
			...
			this.vbox36.Add(this.cmbIDUsuario);
			global::Gtk.Box.BoxChild w24 = ((global::Gtk.Box.BoxChild)(this.vbox36[this.cmbIDUsuario]));
			w24.Position = 2;
			w24.Expand = false;
			w24.Fill = false;
			// Container child vbox36.Gtk.Box+BoxChild
			...
			this.vbox36.Add(this.cmbRol);
			global::Gtk.Box.BoxChild w25 = ((global::Gtk.Box.BoxChild)(this.vbox36[this.cmbRol]));
			w25.Position = 3;
			w25.Expand = false;
			w25.Fill = false;
			...
			this.tvUsuariosRol.RowActivated += new global::Gtk.RowActivatedHandler(this.OnTvUsuariosRolRowActivated);
